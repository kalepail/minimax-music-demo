/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b1daa4eeb0bb8de349f5a1bfb4c4a657)
// Runtime types generated with workerd@1.20260424.1 2026-04-16 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MusicJob" | "RadioStation";
	}
	interface Env {
		...
		RADIO_AUTOFILL: "true";
		MUSIC_JOB: DurableObjectNamespace<import("./src/index").MusicJob>;
		RADIO_STATION: DurableObjectNamespace<import("./src/index").RadioStation>;
		RADIO_SONG_WORKFLOW: Workflow<Parameters<import("./src/index").RadioSongWorkflow['run']>[0]['payload']>;
	}
}
